...
class ProductAdapter(val postList: MutableList<Post>, val priceList: MutableList<PriceDetail>) :
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.apply {
            Glide.with(holder.itemView).load(list.picUrl).placeholder(R.drawable.ic_placeholder).into(binding.ivProductImage)
            ...
            val direction = MainFragmentDirections.actionMainFragmentToRatesFragment(position.toString())
